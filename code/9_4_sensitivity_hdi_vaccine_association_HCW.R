...
writexl::write_xlsx(df_model_vacc_idhm_quartil_estimates, "output/df_model_vacc_idhm_quartil_estimates_hcw.xlsx")
...
ggsave("output/plot_adj_pred_interaction_HCW.png", 
       plot_adj_pred_interaction, 
...
writexl::write_xlsx(
    ...
    "output/model_predict_quart_idhm_hcw.xlsx")
...
writexl::write_xlsx(model_vacc_idhm_quartil_cob_range, "output/Statistics/model_vacc_idhm_quartil_cob_range_HCW.xlsx")
...
ggsave("output/plot_margins_RR_groupHDI_D1_single_HCW.png", plot_margins_RR_groupHDI,
       units = "in", dpi = 800, width = 7, height = 5)
